    ...
    Ta.hack = function () {
        return {
            ...
            conf: {
                ...
                logo: 255,
                hot: {
                    "url": "c.qq.com/|c.qq.com/Act/lucky/SC100|c.qq.com/Act/lucky/kfwspecial|c.qq.com/ListSku/view?firstCateId=100002|c.qq.com/TxZone|c.qq.com/cateTopic/view|c.qq.com/wxZone",
                    "isValid": true
                }
            }
        };
...
(function (h, n) {
    ...
    function y() {
        try {
            var c = navigator, a = screen || {
                    ...
                    height: "",
                    colorDepth: ""
                }, b = document.body, d = a.width + "x" + a.height, e = a.colorDepth + "-bit", f = (c.language || c.userLanguage).toLowerCase(), g = c.javaEnabled() ? 1 : 0, h = (new Date).getTimezoneOffset() / 60, a = "";
    ...
    function u(c) {
        ...
        if (h.sid && !Ta[h.sid]) {
            ...
            var a = Ta.src = ("https:" == document.location.protocol ? "https://pingtas.qq.com/webview" : "http://pingtcss.qq.com") + "/pingd?" + a.join("&"), g = new Image;
            Ta[h.sid] = g;
